...
import { MediaPonderadaComponent } from './media-ponderada/media-ponderada.component';
...
const routes: Routes = [
  ...
  {path:'calculadora-media-simples', component:CalculaMediaSimplesComponent},
  {path:'media-ponderada', component:MediaPonderadaComponent},
  {
